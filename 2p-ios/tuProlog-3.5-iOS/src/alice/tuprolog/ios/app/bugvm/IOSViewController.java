...
import alice.tuprolog.ios.app.sharedclasses.I_URL_Parser;
import alice.tuprolog.ios.app.sharedclasses.URL_Parser;
...
public class IOSViewController extends UIViewController 
{
	...
	private String incipit = "tuProlog Mobile (BugVM) - " + Prolog.getVersion();
