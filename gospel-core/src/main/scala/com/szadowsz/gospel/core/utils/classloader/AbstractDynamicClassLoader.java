package com.szadowsz.gospel.core.utils.classloader;
...
public abstract class AbstractDynamicClassLoader extends ClassLoader {
    ArrayList<URL> listURLs = null;
    final Hashtable<String, Class<?>> classCache = new Hashtable<>();
    ...
    AbstractDynamicClassLoader(URL[] urls, ClassLoader parent) {
        super(parent);
        listURLs = new ArrayList<>(Arrays.asList(urls));
    }
