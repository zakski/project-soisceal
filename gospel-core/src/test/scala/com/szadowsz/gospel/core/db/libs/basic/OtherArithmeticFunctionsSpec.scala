...
class OtherArithmeticFunctionsSpec extends FunSpec with BaseEngineSpec {
  ...
  describe("(**)/2 (power)") {
    ...
    it("should pass variable test #1") {
      ...
      var result = solution.getVarValue("X").asInstanceOf[Double]
  ...
  describe("sin/1") {
    ...
    it("should pass variable test #3") {
      ...
      result = solution.getVarValue("PI").asInstanceOf[Double]
  ...
  describe("cos/1") {
    ...
    describe("atan/1") {
        ...
        val result = solution.getVarValue("PI").asInstanceOf[Double]
        result.doubleValue shouldBe 3.141592653589793
      }
  }
