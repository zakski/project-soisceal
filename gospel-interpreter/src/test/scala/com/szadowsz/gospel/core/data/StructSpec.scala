...
class StructSpec extends FlatSpec with Matchers {
  ...
  it should "be able to construct a list from an argument array" in {
    ...
    list.getListTail.getListTail shouldBe new Struct
  }
  ...
  it should "support appending object to itself properly" in {
    ...
    emptyList.getListTail shouldBe tail
    ...
    list.getListTail.getListTail.getListTail.getListHead shouldBe anotherList
  }
