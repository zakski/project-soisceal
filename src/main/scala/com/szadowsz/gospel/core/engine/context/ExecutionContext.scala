...
import com.szadowsz.gospel.core.engine.subgoal.SubGoalStore
 ...
 * @author Alex Benini
 */
private[gospel] class ExecutionContext (theEngine: Engine, theClause: ClauseInfo, hasAlts: Boolean) {
  ...
  private[gospel] var currentGoal: Struct = null
  private[gospel] var trailingVars: OneWayList[List[Var]] = null
