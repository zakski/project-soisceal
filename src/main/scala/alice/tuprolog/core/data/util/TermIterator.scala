 ...
 */
@SerialVersionUID(1L)
class TermIterator protected[tuprolog] (theParser: Parser) extends Iterator[Term] with Serializable {
  private val _parser: Parser = theParser

  private var _next = _parser.nextTerm(true)
  private var _hasNext = _next != null
