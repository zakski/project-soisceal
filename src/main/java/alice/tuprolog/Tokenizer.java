...
import alice.tuprolog.core.parser.Token;
...
//    static {
//        Arrays.sort(alice.tuprolog.core.parser.Tokenizer.GRAPHIC_CHARS);  // must be done to ensure correct behavior of Arrays.binarySearch
//    }
//
//    /*Castagna 06/2011*/
//    /* Francesco Fabbri
...
//        while (alice.tuprolog.core.parser.Tokenizer.isWhite(typea)) {
//        	/*Castagna 06/2011*/
//            //typea = super.nextToken();
//            typea = tokenConsume();
//            /**/
...
//        if (typea == TT_EOF) return new Token("", alice.tuprolog.core.parser.Tokenizer.EOF);
//        if (typea == '(') return new Token("(", alice.tuprolog.core.parser.Tokenizer.LPAR);
//        if (typea == ')') return new Token(")", alice.tuprolog.core.parser.Tokenizer.RPAR);
//        if (typea == '{') return new Token("{", alice.tuprolog.core.parser.Tokenizer.LBRA2);
//        if (typea == '}') return new Token("}", alice.tuprolog.core.parser.Tokenizer.RBRA2);
//        if (typea == '[') return new Token("[", alice.tuprolog.core.parser.Tokenizer.LBRA);
//        if (typea == ']') return new Token("]", alice.tuprolog.core.parser.Tokenizer.RBRA);
//        if (typea == '|') return new Token("|", alice.tuprolog.core.parser.Tokenizer.BAR);
//
//        if (typea == '!') return new Token("!", alice.tuprolog.core.parser.Tokenizer.ATOM);
//        if (typea == ',') return new Token(",", alice.tuprolog.core.parser.Tokenizer.OPERATOR);
//
...
//            int typeb = tokenConsume();
//        	/**/
//            if (alice.tuprolog.core.parser.Tokenizer.isWhite(typeb) || typeb == '%' || typeb == StreamTokenizer.TT_EOF)
//                return new Token(".", alice.tuprolog.core.parser.Tokenizer.END);
//            else
//            	/*Castagna 06/2011*/
//                //pushBack();
//                tokenPushBack();
...
//                return new Token(svala, alice.tuprolog.core.parser.Tokenizer.VARIABLE);
//
...
//            	/**/
//                if (typeb == '(')
//                    return new Token(svala, alice.tuprolog.core.parser.Tokenizer.ATOM | alice.tuprolog.core.parser.Tokenizer.FUNCTOR);
//                if (alice.tuprolog.core.parser.Tokenizer.isWhite(typeb))
//                    return new Token(svala, alice.tuprolog.core.parser.Tokenizer.ATOM | alice.tuprolog.core.parser.Tokenizer.OPERATOR);
//                return new Token(svala, alice.tuprolog.core.parser.Tokenizer.ATOM);
//            }
//        }
//
//        // quotes
...
//
//        // symbols
//        if (Arrays.binarySearch(alice.tuprolog.core.parser.Tokenizer.GRAPHIC_CHARS, (char) typea) >= 0) {
//
//            /*Castagna 06/2011*/
...
//            int typeb = typea;
//            // String svalb = null;
//            while (Arrays.binarySearch(alice.tuprolog.core.parser.Tokenizer.GRAPHIC_CHARS, (char) typeb) >= 0) {
...
////            }
//            return new Token(symbols.toString(), alice.tuprolog.core.parser.Tokenizer.OPERATOR);
//        }
//
...
//                        return new Token("" + java.lang.Long.parseLong(svala.substring(2), 2), alice.tuprolog.core.parser.Tokenizer.INTEGER); // try binary
//                    if (svala.indexOf('o') == 1)
//                        return new Token("" + java.lang.Long.parseLong(svala.substring(2), 8), alice.tuprolog.core.parser.Tokenizer.INTEGER); // try octal
//                    if (svala.indexOf('x') == 1)
//                        return new Token("" + java.lang.Long.parseLong(svala.substring(2), 16), alice.tuprolog.core.parser.Tokenizer.INTEGER); // try hex
//                }
//
//                // lookahead 1
//                /*Castagna 06/2011*/
...
//                	/**/
//                    return new Token("" + java.lang.Long.parseLong(svala), alice.tuprolog.core.parser.Tokenizer.INTEGER);
//                }
//
...
//                        return new Token("" + intVal, alice.tuprolog.core.parser.Tokenizer.INTEGER);
//
...
//                                return new Token(svala + "." + svalc + (char) typeb2 + svalc2, alice.tuprolog.core.parser.Tokenizer.FLOAT);
//                            }
//                        }
//                    }
//                }
...
//                return new Token(svala + "." + svalc, alice.tuprolog.core.parser.Tokenizer.FLOAT);
//
//            } catch (NumberFormatException e) {
