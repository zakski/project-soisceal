...
public abstract class Library implements Serializable, IPrimitives {
	 ...
	 */
    protected alice.tuprolog.core.Prolog engine;
	 ...
	 * @return  the engine
	 */
    public alice.tuprolog.core.Prolog getEngine() {
        return engine;
    }
    ...
    public Map<Integer,List<PrimitiveInfo>> getPrimitives() {
        try {
            ...
            for (int i = 0; i < mlist.length; i++) {
                ...
                else if (returnTypeName.equals("alice.tuprolog.core.data.Term")) type = PrimitiveInfo.FUNCTOR();
