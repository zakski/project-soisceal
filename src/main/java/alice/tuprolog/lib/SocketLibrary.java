...
import alice.tuprolog.core.data.socket.AbstractSocket;
import alice.tuprolog.core.data.socket.Client_Socket;
import alice.tuprolog.core.data.socket.Datagram_Socket;
import alice.tuprolog.core.data.numeric.Int;
import alice.tuprolog.Library;
//import alice.tuprolog.MalformedGoalException;
//import alice.tuprolog.NoSolutionException;
import alice.tuprolog.core.Prolog;
import alice.tuprolog.core.data.socket.Server_Socket;
...
public class SocketLibrary extends Library implements ISocketLib {
	...
	public boolean udp_send_3(Term Socket, Term Data, Struct AddressTo) throws PrologException
	{
		if (!(Socket.getTerm() instanceof Var)) { // Socket has to be a variable
			throw PrologException.instantiation_error(engine.getEngineManager(), 1);
		}
 ...
 * 
 * @throws PrologException if Socket is not a variable
 */
 ...
 * 
 * @throws PrologException if ServerSock is a variable or it is not a Server_Socket
 */
 ...
 * @throws PrologException if Socket is not a variable
 */
public boolean tcp_socket_client_open_2(Struct Address, Term SocketTerm) throws PrologException {
 ...
 * @throws PrologException if serverSocket is a variable or it is not a Server_Socket
 */
public synchronized boolean tcp_socket_server_close_1(Term serverSocket) throws PrologException {
 ...
 * @throws PrologException if Socket is a variable or it is not a Client_Socket or Msg is not bound
 */
 ...
 * 					predicate fails
 * @throws PrologException if Socket is not bound or it is not a Client_Socket or Msg is bound
 */
 ...
 * @throws PrologException if Socket is not bound or it is not a Client_Socket
 */
...
public boolean getAddress_2(Term sock, Term addr) throws PrologException {
