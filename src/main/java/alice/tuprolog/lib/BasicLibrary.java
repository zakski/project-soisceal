...
import alice.tuprolog.core.Agent;
import alice.tuprolog.core.data.Struct;
import alice.tuprolog.core.data.Term;
import alice.tuprolog.core.data.Var;
import alice.tuprolog.core.data.numeric.*;
import alice.tuprolog.core.data.numeric.Double;
...
public class BasicLibrary extends Library {
	...
	public boolean integer_1(Term t) {
		if (!(t.getTerm() instanceof Number))
			return false;
		alice.tuprolog.core.data.numeric.Number n = (alice.tuprolog.core.data.numeric.Number) t.getTerm();
		return (n.isInteger());
	}
	...
	public boolean expression_equality_2(Term arg0, Term arg1) throws PrologException {
		...
		alice.tuprolog.core.data.numeric.Number val0n = (alice.tuprolog.core.data.numeric.Number) val0;
		alice.tuprolog.core.data.numeric.Number val1n = (alice.tuprolog.core.data.numeric.Number) val1;
	...
	public boolean expression_greater_than_2(Term arg0, Term arg1) throws PrologException {
		...
		if (val1 == null || !(val1 instanceof Number))
			throw PrologException.type_error(engine.getEngineManager(), 2, "evaluable", arg1.getTerm());
		return expression_greater_than((alice.tuprolog.core.data.numeric.Number) val0, (alice.tuprolog.core.data.numeric.Number) val1);
	}
	...
	private boolean expression_greater_than(alice.tuprolog.core.data.numeric.Number num0, alice.tuprolog.core.data.numeric.Number num1) {
	...
	public boolean expression_less_than_2(Term arg0, Term arg1) throws PrologException {
		...
		if (val1 == null || !(val1 instanceof Number))
			throw PrologException.type_error(engine.getEngineManager(), 2, "evaluable", arg1.getTerm());
		return expression_less_than((alice.tuprolog.core.data.numeric.Number) val0, (alice.tuprolog.core.data.numeric.Number) val1);
	}
	...
	private boolean expression_less_than(alice.tuprolog.core.data.numeric.Number num0, alice.tuprolog.core.data.numeric.Number num1) {
		if (num0.isInteger() && num1.isInteger()) {
			// return num0.intValue() < num1.intValue();
			return num0.longValue() < num1.longValue();
		} else {
	...
	public Term expression_minus_1(Term arg0) {
		...
		if (val0 != null && val0 instanceof Number) {
			...
			if (val0n instanceof Int) {
				...
				return new Float(val0n.floatValue() * -1);
			} else {
				return null;
			}
		} else {
	...
	public Term expression_bitwise_not_1(Term arg0) {
		...
		if (val0 != null && val0 instanceof Number) {
			// return new Int(~((alice.tuprolog.core.data.numeric.Number) val0).intValue());
			// CORRECTED BY ED ON JAN 28, 2011
			return new Long(~((alice.tuprolog.core.data.numeric.Number) val0).longValue());
		} else {
			return null;
		}
	}

	alice.tuprolog.core.data.numeric.Number getIntegerNumber(long num) {
	...
	public Term expression_minus_2(Term arg0, Term arg1) {
		...
		if (val0 != null && val1 != null && val0 instanceof Number && (val1 instanceof Number)) {
			...
			Number val1n = (alice.tuprolog.core.data.numeric.Number) val1;
			if (val0n.isInteger() && (val1n.isInteger()))
				return getIntegerNumber(val0n.longValue() - val1n.longValue());
			else
				return new Double(val0n.doubleValue() - val1n.doubleValue());
	...
	public Term expression_integer_div_2(Term arg0, Term arg1) {
		...
		if (val0 != null && val1 != null && val0 instanceof Number && (val1 instanceof Number)) {
			alice.tuprolog.core.data.numeric.Number val0n = (Number) val0;
			alice.tuprolog.core.data.numeric.Number val1n = (alice.tuprolog.core.data.numeric.Number) val1;
			return getIntegerNumber(val0n.longValue() / val1n.longValue());
		} else {
			return null;
	...
	public Term expression_bitwise_shift_right_2(Term arg0, Term arg1) {
		...
		if (val0 != null && val1 != null && val0 instanceof Number && val1 instanceof Number) {
			Number val0n = (alice.tuprolog.core.data.numeric.Number) val0;
			alice.tuprolog.core.data.numeric.Number val1n = (alice.tuprolog.core.data.numeric.Number) val1;
			// return new Int(val0n.intValue() >> val1n.intValue());
			// CORRECTED BY ED ON JAN 28, 2011
			return new alice.tuprolog.core.data.numeric.Long(val0n.longValue() >> val1n.longValue());
		} else {
			return null;
		}
	}
	...
	public Term expression_bitwise_shift_left_2(Term arg0, Term arg1) {
		...
		if (val0 != null && val1 != null && val0 instanceof Number && val1 instanceof Number) {
			...
			// return new Int(val0n.intValue() << val1n.intValue());
			// CORRECTED BY ED ON JAN 28, 2011
			return new Long(val0n.longValue() << val1n.longValue());
		} else {
			return null;
		}
	}
	...
	public boolean num_atom_2(Term arg0, Term arg1) throws PrologException {
		...
		if (arg1 instanceof Var) {
			...
			alice.tuprolog.core.data.numeric.Number n0 = (alice.tuprolog.core.data.numeric.Number) arg0;
			String st = null;
			if (n0.isInteger()) {
			...
			Term term = null;
			try {
				term = new alice.tuprolog.core.data.numeric.Int(java.lang.Integer.parseInt(st2));
			} catch (Exception ex) {
			}
			if (term == null) {
				try {
