...
import alice.tuprolog.core.exception.JVMException;
import alice.tuprolog.core.exception.interpreter.InvalidObjectIdException;
...
public class OOLibrary extends Library {
    ...
    private boolean java_set(Term objId, Term fieldTerm, Term what) {
        ...
        try {
            ...
            if (what instanceof Number) {
                ...
                } else if (wn instanceof alice.tuprolog.core.data.numeric.Float) {
    ...
    private boolean java_get(Term objId, Term fieldTerm, Term what) {
        ...
        try {
            ...
            if (fc.equals(Integer.TYPE) || fc.equals(Byte.TYPE)) {
                ...
                return unify(what, new alice.tuprolog.core.data.numeric.Int(value));
    ...
    public boolean java_array_get_primitive_3(Term obj_id, Term i, Term what) throws JVMException {
        ...
        try {
            ...
            String name = cl.toString();
            if (name.equals("class [I")) {
                Term value = new alice.tuprolog.core.data.numeric.Int(Array.getInt(obj, index.intValue()));
                if (unify(what, value))
                    return true;
                else
                ...
                Term value = new alice.tuprolog.core.data.numeric.Int(Array.getByte(obj, index
                        .intValue()));
                if (unify(what, value))
                    return true;
                else
                ...
                Term value = new alice.tuprolog.core.data.numeric.Int(Array.getInt(obj, index
                        .intValue()));
                if (unify(what, value))
                    return true;
                else
