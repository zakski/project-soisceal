...
public class DCGLibrary extends Library {
    ...
    public boolean phrase_guard_2(Term arg0, Term arg1) throws PrologException {
        arg0 = arg0.getTerm();
    ...
    public boolean phrase_guard_3(Term arg0, Term arg1, Term arg2) throws PrologException {
        arg0 = arg0.getTerm();
        if (arg0 instanceof Var)
            throw PrologException.instantiation_error(engine.getEngineManager(), 1);
        return true;
