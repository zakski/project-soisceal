...
public class PJ implements MethodHandler {
    ...
    public static alice.tuprolog.core.data.Struct registerJavaObject(Object o) {
    ...
    public static Object getRegisteredJavaObject(alice.tuprolog.core.data.Struct t) {
    ...
    public static void assertClause(PrologObject po, alice.tuprolog.core.data.Term clause) {
        try {
            pushEngine();
    ...
    public static void retractClause(PrologObject po, alice.tuprolog.core.data.Term clause) {
        try {
            pushEngine();
            engine().setTheory(po.getTheory());
    ...
    public static void retractAllClauses(PrologObject po, alice.tuprolog.core.data.Term clause) {
        try {
            pushEngine();
            engine().setTheory(po.getTheory());
            alice.tuprolog.core.data.Struct goal = new alice.tuprolog.core.data.Struct("retractall", clause);
