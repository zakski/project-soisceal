...
public class ISOLibrary extends Library {
    ...
    public boolean atom_length_2(Term arg0, Term len) throws PrologException {
        arg0 = arg0.getTerm();
        if (arg0 instanceof Var)
            throw PrologException.instantiation_error(engine.getEngineManager(), 1);
        if (!arg0.isAtom())
            throw PrologException.type_error(engine.getEngineManager(), 1, "atom",
                    arg0);
        Struct atom = (Struct) arg0;
        return unify(len, new Int(atom.getName().length()));
    }

    public boolean atom_chars_2(Term arg0, Term arg1) throws PrologException {
        arg0 = arg0.getTerm();
        arg1 = arg1.getTerm();
        if (arg0 instanceof Var) {
            if (!arg1.isList()) {
                throw PrologException.type_error(engine.getEngineManager(), 2,
                        "list", arg1);
            }
    ...
    public boolean char_code_2(Term arg0, Term arg1) throws PrologException {
        arg0 = arg0.getTerm();
        arg1 = arg1.getTerm();
        if (arg1 instanceof Var) {
            if (arg0.isAtom()) {
                ...
                || (arg1 instanceof com.szadowsz.gospel.core.data.numeric.Long)) {
            char c = (char) ((com.szadowsz.gospel.core.data.numeric.Number) arg1).intValue();
    ...
    public Term sin_1(Term val) {
        ...
        if (val0 instanceof com.szadowsz.gospel.core.data.numeric.Number)
            return new com.szadowsz.gospel.core.data.numeric.Double(Math.sin(((com.szadowsz.gospel.core.data.numeric.Number) val0)
                    .doubleValue()));
        return null;
    }
    ...
    public Term cos_1(Term val) {
        ...
        if (val0 instanceof com.szadowsz.gospel.core.data.numeric.Number)
            return new Double(Math.cos(((com.szadowsz.gospel.core.data.numeric.Number) val0)
                    .doubleValue()));
        return null;
    }
    ...
    public Term exp_1(Term val) {
        ...
        if (val0 instanceof com.szadowsz.gospel.core.data.numeric.Number)
            return new Double(Math.exp(((com.szadowsz.gospel.core.data.numeric.Number) val0)
                    .doubleValue()));
        return null;
    }
    ...
    public Term atan_1(Term val) {
        ...
        if (val0 instanceof com.szadowsz.gospel.core.data.numeric.Number)
            return new Double(Math.atan(((com.szadowsz.gospel.core.data.numeric.Number) val0)
                    .doubleValue()));
        return null;
    }
    ...
    public Term log_1(Term val) {
        ...
        if (val0 instanceof com.szadowsz.gospel.core.data.numeric.Number)
            return new Double(Math.log(((com.szadowsz.gospel.core.data.numeric.Number) val0)
                    .doubleValue()));
        return null;
    }
    ...
    public Term sqrt_1(Term val) {
        ...
        if (val0 instanceof com.szadowsz.gospel.core.data.numeric.Number)
            return new Double(Math.sqrt(((com.szadowsz.gospel.core.data.numeric.Number) val0)
                    .doubleValue()));
        return null;
    }
    ...
    public Term abs_1(Term val) {
        ...
        if (val0 instanceof Int || val0 instanceof com.szadowsz.gospel.core.data.numeric.Long)
            return new Int(Math.abs(((com.szadowsz.gospel.core.data.numeric.Number) val0).intValue()));
        if (val0 instanceof Double
                || val0 instanceof com.szadowsz.gospel.core.data.numeric.Float)
            return new Double(Math.abs(((com.szadowsz.gospel.core.data.numeric.Number) val0)
                    .doubleValue()));
        return null;
    }
    ...
    public Term sign_1(Term val) {
        ...
        if (val0 instanceof Int || val0 instanceof com.szadowsz.gospel.core.data.numeric.Long)
            return new Double(
                    ((com.szadowsz.gospel.core.data.numeric.Number) val0).intValue() > 0 ? 1.0 : -1.0);
        if (val0 instanceof Double
                || val0 instanceof com.szadowsz.gospel.core.data.numeric.Float)
            return new Double(
                    ((com.szadowsz.gospel.core.data.numeric.Number) val0).doubleValue() > 0 ? 1.0 : -1.0);
        return null;
    }
    ...
    public Term float_integer_part_1(Term val) {
        ...
        if (val0 instanceof com.szadowsz.gospel.core.data.numeric.Number)
            return new Double((long) Math.rint(((com.szadowsz.gospel.core.data.numeric.Number) val0)
                    .doubleValue()));
        return null;
    }
    ...
    public Term float_fractional_part_1(Term val) {
        ...
        if (val0 instanceof com.szadowsz.gospel.core.data.numeric.Number) {
            double fl = ((com.szadowsz.gospel.core.data.numeric.Number) val0).doubleValue();
    ...
    public Term float_1(Term val) {
        ...
        if (val0 instanceof com.szadowsz.gospel.core.data.numeric.Number)
            return new Double(((com.szadowsz.gospel.core.data.numeric.Number) val0).doubleValue());
        return null;
    }
    ...
    public Term floor_1(Term val) {
        ...
        if (val0 instanceof com.szadowsz.gospel.core.data.numeric.Number)
            return new Int((int) Math.floor(((com.szadowsz.gospel.core.data.numeric.Number) val0).doubleValue()));
        return null;
    }
    ...
    public Term round_1(Term val) {
        ...
        if (val0 instanceof com.szadowsz.gospel.core.data.numeric.Number)
            return new com.szadowsz.gospel.core.data.numeric.Long(Math.round(((com.szadowsz.gospel.core.data.numeric.Number) val0)
                    .doubleValue()));
        return null;
    }
    ...
    public Term truncate_1(Term val) {
        ...
        if (val0 instanceof com.szadowsz.gospel.core.data.numeric.Number)
            return new Int((int) Math.rint(((com.szadowsz.gospel.core.data.numeric.Number) val0).doubleValue()));
        return null;
    }
    ...
    public Term ceiling_1(Term val) {
        ...
        if (val0 instanceof com.szadowsz.gospel.core.data.numeric.Number)
            return new Int((int) Math.ceil(((com.szadowsz.gospel.core.data.numeric.Number) val0).doubleValue()));
        return null;
    }

    public Term div_2(Term v0, Term v1) throws PrologException {
        Term val0 = null;
        Term val1 = null;
        try {
        ...
        if (val0 instanceof com.szadowsz.gospel.core.data.numeric.Number && val1 instanceof com.szadowsz.gospel.core.data.numeric.Number)
            return new Int(((com.szadowsz.gospel.core.data.numeric.Number) val0).intValue()
                    / ((com.szadowsz.gospel.core.data.numeric.Number) val1).intValue());
        return null;
    }

    public Term mod_2(Term v0, Term v1) throws PrologException {
        Term val0 = null;
        Term val1 = null;
        try {
            val0 = evalExpression(v0);
        ...
        if (val0 instanceof com.szadowsz.gospel.core.data.numeric.Number && val1 instanceof com.szadowsz.gospel.core.data.numeric.Number) {
            int x = ((com.szadowsz.gospel.core.data.numeric.Number) val0).intValue();
            int y = ((com.szadowsz.gospel.core.data.numeric.Number) val1).intValue();
    ...
    public Term rem_2(Term v0, Term v1) {
        ...
        if (val0 instanceof com.szadowsz.gospel.core.data.numeric.Number && val1 instanceof com.szadowsz.gospel.core.data.numeric.Number) {
            return new Double(Math.IEEEremainder(((com.szadowsz.gospel.core.data.numeric.Number) val0)
                    .doubleValue(), ((com.szadowsz.gospel.core.data.numeric.Number) val1).doubleValue()));
        }
        return null;
    }
    ...
    public boolean sub_atom_guard_5(Term arg0, Term arg1, Term arg2, Term arg3, Term arg4)
        ...
        arg0 = arg0.getTerm();
        if (!arg0.isAtom())
            throw PrologException.type_error(engine.getEngineManager(), 1, "atom", arg0);
        return true;
    }
