...
public class IOLibrary extends Library {
    ...
    public boolean see_1(Term arg) throws PrologException {
        arg = arg.getTerm();
        ...
        if (arg0.getName().equals(STDIN_NAME)) { /*No matter what is the StandardInput ("console", "graphic", etc.). The user does not know what it is*/
            ...
            try {
                ...
                throw PrologException.domain_error(engine.getEngineManager(), 1,
                        "stream", arg0);
            }
        }
    ...
    public boolean tell_1(Term arg) throws PrologException {
        arg = arg.getTerm();
        if (arg instanceof Var)
            throw PrologException.instantiation_error(engine.getEngineManager(), 1);
        if (!arg.isAtom()) {
    ...
    public boolean put_1(Term arg) throws PrologException {
        arg = arg.getTerm();
        if (arg instanceof Var)
            throw PrologException.instantiation_error(engine.getEngineManager(), 1);
        if (!arg.isAtom()) {
            ...
            if (ch.length() > 1) {
                ...
                if (outputStreamName.equals(STDOUT_NAME)) { /* Changed from "stdout" to STDOUT_NAME */
                    ...
                    try {
                        ...
                        throw PrologException.permission_error(engine
    ...
    public boolean get0_1(Term arg0) throws PrologException {
        int ch = -2;
        try {
            ch = inputStream.read();
        } catch (IOException e) {
            throw PrologException.permission_error(engine.getEngineManager(),
    ...
    public boolean get_1(Term arg0) throws PrologException {
        int ch = 0;
        do {
            try {
                ch = inputStream.read();
    ...
    public boolean tab_1(Term arg) throws PrologException {
        arg = arg.getTerm();
        if (arg instanceof Var)
            throw PrologException.instantiation_error(engine.getEngineManager(), 1);
    ...
    public boolean read_1(Term arg0) throws PrologException {
        arg0 = arg0.getTerm();
        int ch = 0;
        ...
        try {
            ...
            /*Castagna 06/2011*/
        	//throw PrologException.syntax_error(engine.getEngineManager(), -1, -1, new Struct(st));
        	throw PrologException.syntax_error(engine.getEngineManager(),-1, e.getLine(), e.getColumn(), new Struct(st));
        	/**/
        }
        return true;
    }

    public boolean write_1(Term arg0) throws PrologException {
        arg0 = arg0.getTerm();
    ...
    public boolean print_1(Term arg0) throws PrologException {
        arg0 = arg0.getTerm();
        if (arg0 instanceof Var)
            throw PrologException.instantiation_error(engine.getEngineManager(), 1);
        if (outputStreamName.equals(STDOUT_NAME)) { /* Changed from "stdout" to STDOUT_NAME */
    ...
    public boolean nl_0() throws PrologException {
        if (outputStreamName.equals(STDOUT_NAME)) { /* Changed from "stdout" to STDOUT_NAME */
            getEngine().stdOutput("\n");
        } else {
            try {
    ...
    public boolean text_from_file_2(Term file_name, Term text)
        ...
        try {
            ...
            throw PrologException.existence_error(engine.getEngineManager(), 1,
     ...
     */
    public boolean set_seed_1(Term t) throws PrologException {
        t = t.getTerm();
        if( !(t instanceof com.szadowsz.gospel.core.data.numeric.Number) ) {
            throw PrologException.type_error(engine.getEngineManager(), 1, "Integer Number", t);
        }
        com.szadowsz.gospel.core.data.numeric.Number seed = (com.szadowsz.gospel.core.data.numeric.Number)t;
        if( !seed.isInteger() ){
            throw PrologException.type_error(engine.getEngineManager(), 1, "Integer Number", t);
        }
        gen.setSeed(((com.szadowsz.gospel.core.data.numeric.Number)seed).longValue());
        return true;
    }

    public boolean rand_float_1(Term t) {
        return unify(t, new com.szadowsz.gospel.core.data.numeric.Double(gen.nextFloat()));
    }

    public boolean rand_int_2(Term argNum, Term num) {
        com.szadowsz.gospel.core.data.numeric.Number arg = (com.szadowsz.gospel.core.data.numeric.Number) argNum.getTerm();
    ...
    public boolean write_base_1(Term arg0) throws PrologException {
        arg0 = arg0.getTerm();
