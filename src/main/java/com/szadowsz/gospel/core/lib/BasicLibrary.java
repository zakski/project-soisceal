...
public class BasicLibrary extends Library {
	 ...
	 */
	public boolean set_theory_1(Term th) throws PrologException {
		th = th.getTerm();
		if (th instanceof Var)
			throw PrologException.instantiation_error(engine.getEngineManager(), 1);
		if (!th.isAtom()) {
			throw PrologException.type_error(engine.getEngineManager(), 1, "atom", th);
		}
		try {
			...
			/* Castagna 06/2011 */
			// throw PrologException.syntax_error(engine.getEngineManager(), ex.line, ex.pos, new Struct(ex.getMessage()));
			throw PrologException.syntax_error(engine.getEngineManager(), ex.clause(), ex.line(), ex.pos(), new Struct(ex.getMessage())); // TODO fix scala/java
			/**/
		}
	}
	 ...
	 * @throws PrologException
	 */
	public boolean add_theory_1(Term th) throws PrologException {
		th = th.getTerm();
		if (th instanceof Var)
			throw PrologException.instantiation_error(engine.getEngineManager(), 1);
		if (!th.isAtom()) {
	...
	public boolean get_operators_list_1(Term argument) {
		...
		while (it.hasNext()) {
			Operator o = it.next();
			list = new Struct(new Struct("op", new Int(o.prio), new Struct(o.type), new Struct(o.name)), list);
		}
	 ...
	 * @throws PrologException
	 */
	public boolean agent_1(Term th) throws PrologException {
		th = th.getTerm();
		if (th instanceof Var)
			throw PrologException.instantiation_error(engine.getEngineManager(), 1);
		if (!(th.isAtom()))
	 ...
	 * @throws PrologException
	 */
	public boolean agent_2(Term th, Term g) throws PrologException {
		th = th.getTerm();
		g = g.getTerm();
		if (th instanceof Var)
			throw PrologException.instantiation_error(engine.getEngineManager(), 1);
		...
		if (!(g instanceof Struct))
			throw PrologException.type_error(engine.getEngineManager(), 2, "struct", g);
		Struct theory = (Struct) th;
		Struct goal = (Struct) g;
		try {
			new Agent(Tools.removeApices(theory.toString()), goal.toString() + ".").spawn();
			return true;
		} catch (Exception ex) {
			ex.printStackTrace();
			return false;
	...
	public boolean number_1(Term t) {
		return (t.getTerm() instanceof com.szadowsz.gospel.core.data.numeric.Number);
	}

	public boolean integer_1(Term t) {
		if (!(t.getTerm() instanceof com.szadowsz.gospel.core.data.numeric.Number))
			return false;
		com.szadowsz.gospel.core.data.numeric.Number n = (com.szadowsz.gospel.core.data.numeric.Number) t.getTerm();
		return (n.isInteger());
	}

	public boolean float_1(Term t) {
		if (!(t instanceof com.szadowsz.gospel.core.data.numeric.Number))
			return false;
		com.szadowsz.gospel.core.data.numeric.Number n = (com.szadowsz.gospel.core.data.numeric.Number) t.getTerm();
		return (n.isReal());
	}
	...
	private void handleError(Throwable t, int arg) throws PrologException {
		...
		if (t instanceof ArithmeticException) {
			...
			if (cause.getMessage().equals("/ by zero"))
				throw PrologException.evaluation_error(engine.getEngineManager(), arg, "zero_divisor");
		}
	}

	public boolean expression_equality_2(Term arg0, Term arg1) throws PrologException {
		...
		if (val0 == null || !(val0 instanceof com.szadowsz.gospel.core.data.numeric.Number))
			throw PrologException.type_error(engine.getEngineManager(), 1, "evaluable", arg0.getTerm());
		if (val1 == null || !(val1 instanceof com.szadowsz.gospel.core.data.numeric.Number))
			throw PrologException.type_error(engine.getEngineManager(), 2, "evaluable", arg1.getTerm());
		com.szadowsz.gospel.core.data.numeric.Number val0n = (com.szadowsz.gospel.core.data.numeric.Number) val0;
		com.szadowsz.gospel.core.data.numeric.Number val1n = (com.szadowsz.gospel.core.data.numeric.Number) val1;
	...
	public boolean expression_greater_than_2(Term arg0, Term arg1) throws PrologException {
		if (arg0.getTerm() instanceof Var)
			throw PrologException.instantiation_error(engine.getEngineManager(), 1);
		if (arg1.getTerm() instanceof Var)
			throw PrologException.instantiation_error(engine.getEngineManager(), 2);
		...
		if (val1 == null || !(val1 instanceof com.szadowsz.gospel.core.data.numeric.Number))
			throw PrologException.type_error(engine.getEngineManager(), 2, "evaluable", arg1.getTerm());
		return expression_greater_than((com.szadowsz.gospel.core.data.numeric.Number) val0, (com.szadowsz.gospel.core.data.numeric.Number) val1);
	}

	public boolean expression_less_or_equal_than_2(Term arg0, Term arg1) throws PrologException {
		if (arg0.getTerm() instanceof Var)
			throw PrologException.instantiation_error(engine.getEngineManager(), 1);
		if (arg1.getTerm() instanceof Var)
			throw PrologException.instantiation_error(engine.getEngineManager(), 2);
	...
	private boolean expression_greater_than(com.szadowsz.gospel.core.data.numeric.Number num0, com.szadowsz.gospel.core.data.numeric.Number num1) {
	...
	public boolean expression_less_than_2(Term arg0, Term arg1) throws PrologException {
		if (arg0.getTerm() instanceof Var)
			throw PrologException.instantiation_error(engine.getEngineManager(), 1);
		if (arg1.getTerm() instanceof Var)
			throw PrologException.instantiation_error(engine.getEngineManager(), 2);
		...
		if (val1 == null || !(val1 instanceof com.szadowsz.gospel.core.data.numeric.Number))
			throw PrologException.type_error(engine.getEngineManager(), 2, "evaluable", arg1.getTerm());
		return expression_less_than((com.szadowsz.gospel.core.data.numeric.Number) val0, (com.szadowsz.gospel.core.data.numeric.Number) val1);
	}

	public boolean expression_greater_or_equal_than_2(Term arg0, Term arg1) throws PrologException {
		if (arg0.getTerm() instanceof Var)
			throw PrologException.instantiation_error(engine.getEngineManager(), 1);
		if (arg1.getTerm() instanceof Var)
			throw PrologException.instantiation_error(engine.getEngineManager(), 2);
	...
	private boolean expression_less_than(com.szadowsz.gospel.core.data.numeric.Number num0, com.szadowsz.gospel.core.data.numeric.Number num1) {
		if (num0.isInteger() && num1.isInteger()) {
			// return num0.intValue() < num1.intValue();
			return num0.longValue() < num1.longValue();
		} else {
	...
	public boolean term_equality_2(Term arg0, Term arg1) throws PrologException {
		arg0 = arg0.getTerm();
		arg1 = arg1.getTerm();
		return arg0.isEqual(arg1);
	}

	public boolean term_greater_than_2(Term arg0, Term arg1) throws PrologException {
		arg0 = arg0.getTerm();
		arg1 = arg1.getTerm();
	...
	public boolean term_less_than_2(Term arg0, Term arg1) throws PrologException {
		arg0 = arg0.getTerm();
		arg1 = arg1.getTerm();
	...
	public Term expression_minus_1(Term arg0) {
		...
		if (val0 != null && val0 instanceof com.szadowsz.gospel.core.data.numeric.Number) {
			...
			} else if (val0n instanceof com.szadowsz.gospel.core.data.numeric.Double) {
				return new Double(val0n.doubleValue() * -1);
			} else if (val0n instanceof com.szadowsz.gospel.core.data.numeric.Long) {
				return new com.szadowsz.gospel.core.data.numeric.Long(val0n.longValue() * -1);
			} else if (val0n instanceof com.szadowsz.gospel.core.data.numeric.Float) {
				return new com.szadowsz.gospel.core.data.numeric.Float(val0n.floatValue() * -1);
			} else {
				return null;
			}
		} else {
	...
	public Term expression_bitwise_not_1(Term arg0) {
		...
		if (val0 != null && val0 instanceof com.szadowsz.gospel.core.data.numeric.Number) {
			// return new Int(~((alice.gospel.core.data.numeric.Number) val0).intValue());
			// CORRECTED BY ED ON JAN 28, 2011
			return new com.szadowsz.gospel.core.data.numeric.Long(~((com.szadowsz.gospel.core.data.numeric.Number) val0).longValue());
		} else {
			return null;
		}
	}

	com.szadowsz.gospel.core.data.numeric.Number getIntegerNumber(long num) {
		if (num > Integer.MIN_VALUE && num < Integer.MAX_VALUE)
			return new Int((int) num);
		else
			return new com.szadowsz.gospel.core.data.numeric.Long(num);
	}
	...
	public Term expression_plus_2(Term arg0, Term arg1) {
		...
		if (val0 != null && val1 != null && val0 instanceof com.szadowsz.gospel.core.data.numeric.Number && (val1 instanceof com.szadowsz.gospel.core.data.numeric.Number)) {
			com.szadowsz.gospel.core.data.numeric.Number val0n = (com.szadowsz.gospel.core.data.numeric.Number) val0;
			com.szadowsz.gospel.core.data.numeric.Number val1n = (com.szadowsz.gospel.core.data.numeric.Number) val1;
			if (val0n.isInteger() && (val1n.isInteger()))
				return getIntegerNumber(val0n.longValue() + val1n.longValue());
			else
				return new Double(val0n.doubleValue() + val1n.doubleValue());
		} else
			return null;
	}
	...
	public Term expression_pow_2(Term arg0, Term arg1) {
		...
		if (val0 != null && val1 != null && val0 instanceof com.szadowsz.gospel.core.data.numeric.Number && (val1 instanceof com.szadowsz.gospel.core.data.numeric.Number)) {
			com.szadowsz.gospel.core.data.numeric.Number val0n = (com.szadowsz.gospel.core.data.numeric.Number) val0;
			com.szadowsz.gospel.core.data.numeric.Number val1n = (com.szadowsz.gospel.core.data.numeric.Number) val1;
			return new Double(Math.pow(val0n.doubleValue(), val1n.doubleValue()));
		} else {
			return null;
		}
	}
	...
	public Term expression_bitwise_shift_right_2(Term arg0, Term arg1) {
		...
		if (val0 != null && val1 != null && val0 instanceof com.szadowsz.gospel.core.data.numeric.Number && val1 instanceof com.szadowsz.gospel.core.data.numeric.Number) {
			...
			// CORRECTED BY ED ON JAN 28, 2011
			return new com.szadowsz.gospel.core.data.numeric.Long(val0n.longValue() >> val1n.longValue());
		} else {
			return null;
		}
	}
	...
	public boolean text_concat_3(Term source1, Term source2, Term dest) throws PrologException {
		...
		if (source2 instanceof Var)
			throw PrologException.instantiation_error(engine.getEngineManager(), 2);
		if (!source1.isAtom())
			throw PrologException.type_error(engine.getEngineManager(), 1, "atom", source1);
		if (!source2.isAtom())
			throw PrologException.type_error(engine.getEngineManager(), 2, "atom", source2);
		return unify(dest, new Struct(((Struct) source1).getName() + ((Struct) source2).getName()));
	}

	public boolean num_atom_2(Term arg0, Term arg1) throws PrologException {
		arg0 = arg0.getTerm();
		arg1 = arg1.getTerm();
		if (arg1 instanceof Var) {
			if (!(arg0 instanceof com.szadowsz.gospel.core.data.numeric.Number)) {
				throw PrologException.type_error(engine.getEngineManager(), 1, "number", arg0);
			}
			com.szadowsz.gospel.core.data.numeric.Number n0 = (com.szadowsz.gospel.core.data.numeric.Number) arg0;
			String st = null;
			if (n0.isInteger()) {
			...
			if (!arg1.isAtom()) {
				throw PrologException.type_error(engine.getEngineManager(), 2, "atom", arg1);
			}
			...
			for (int i = 0; i < numBetween; i += 2) {
				for (int j = java.lang.Integer.parseInt("" + iBetween.charAt(i)); j < java.lang.Integer.parseInt("" + iBetween.charAt(i + 1)); j++) {
					if (st2.charAt(j) != '.'
							&& (st2.charAt(i) != 'E' || (st2.charAt(i) != 'E' && (st2.charAt(i + 1) != '+' || st2.charAt(i + 1) != '-')))
							&& (st2.charAt(i) != 'e' || (st2.charAt(i) != 'e' && (st2.charAt(i + 1) != '+' || st2.charAt(i + 1) != '-')))) {
						st3 = "";
					}
				}
			...
			for (int i = 0; i < numAfter; i++) {
				if ((st2.charAt(i) != 'E' || (st2.charAt(i) != 'E' && (st2.charAt(i + 1) != '+' || st2.charAt(i + 1) != '-')))
						&& st2.charAt(i) != '.'
						&& (st2.charAt(i) != 'e' || (st2.charAt(i) != 'e' && (st2.charAt(i + 1) != '+' || st2.charAt(i + 1) != '-'))))
					st3 = "";
			}
			...
			if (term == null) {
				try {
					term = new Double(java.lang.Double.parseDouble(st2));
				} catch (Exception ex) {
				}
			}
			if (term == null) {
				throw PrologException.domain_error(engine.getEngineManager(), 2, "num_atom", arg1);
			}
	...
	// throw/1
	public boolean throw_1(Term error) throws PrologException {
	...
	public boolean arg_guard_3(Term arg0, Term arg1, Term arg2) throws PrologException {
		arg0 = arg0.getTerm();
		arg1 = arg1.getTerm();
		...
		if (!(arg0 instanceof Int))
			throw PrologException.type_error(engine.getEngineManager(), 1, "integer", arg0);
		if (!arg1.isCompound())
			throw PrologException.type_error(engine.getEngineManager(), 2, "compound", arg1);
		Int arg0int = (Int) arg0;
		if (arg0int.intValue() < 1)
			throw PrologException.domain_error(engine.getEngineManager(), 1, "greater_than_zero", arg0);
		return true;
	}

	public boolean clause_guard_2(Term arg0, Term arg1) throws PrologException {
		arg0 = arg0.getTerm();
		if (arg0 instanceof Var)
			throw PrologException.instantiation_error(engine.getEngineManager(), 1);
		return true;
	...
	public boolean call_guard_1(Term arg0) throws PrologException {
		arg0 = arg0.getTerm();
		if (arg0 instanceof Var)
			throw PrologException.instantiation_error(engine.getEngineManager(), 1);
		if (!arg0.isAtom() && !arg0.isCompound())
			throw PrologException.type_error(engine.getEngineManager(), 1, "callable", arg0);
		return true;
	}

	public boolean all_solutions_predicates_guard_3(Term arg0, Term arg1, Term arg2) throws PrologException {
		...
		if (!arg1.isAtom() && !arg1.isCompound()) {
			...
			throw PrologException.type_error(engine.getEngineManager(), 2, "callable", arg1);
		}
		return true;
	}

	public boolean retract_guard_1(Term arg0) throws PrologException {
		arg0 = arg0.getTerm();
		if (arg0 instanceof Var)
			throw PrologException.instantiation_error(engine.getEngineManager(), 1);
		if (!(arg0 instanceof Struct))
			throw PrologException.type_error(engine.getEngineManager(), 1, "clause", arg0);
		return true;
	}

	public boolean member_guard_2(Term arg0, Term arg1) throws PrologException {
		arg1 = arg1.getTerm();
		if (!(arg1 instanceof Var) && !(arg1.isList()))
			throw PrologException.type_error(engine.getEngineManager(), 2, "list", arg1);
		return true;
	}

	public boolean reverse_guard_2(Term arg0, Term arg1) throws PrologException {
		arg0 = arg0.getTerm();
		if (!(arg0 instanceof Var) && !(arg0.isList()))
			throw PrologException.type_error(engine.getEngineManager(), 1, "list", arg0);
		return true;
	}

	public boolean delete_guard_3(Term arg0, Term arg1, Term arg2) throws PrologException {
		arg1 = arg1.getTerm();
		if (!(arg1 instanceof Var) && !(arg1.isList()))
			throw PrologException.type_error(engine.getEngineManager(), 2, "list", arg1);
		return true;
	...
	public boolean element_guard_3(Term arg0, Term arg1, Term arg2) throws PrologException {
		arg1 = arg1.getTerm();
		if (!(arg1 instanceof Var) && !(arg1.isList()))
			throw PrologException.type_error(engine.getEngineManager(), 2, "list", arg1);
		return true;
	...
	public boolean $wt_unify_3(Term witness, Term wtList, Term tList) {
		...
		for (Iterator<? extends Term> it = list.iterator(); it.hasNext();) {
	...
	public boolean $wt_unify_6(Term witness, Term wtList, Term tList, Term varSet, Term temp, Term goal) {
		...
		Iterator<? extends Term> it1 = freeVarList.iterator();
		if (it1.hasNext()) {
	...
	public String[][] getSynonymMap() {
		return new String[][] { { "+", "expression_plus", "functor" }, { "-", "expression_minus", "functor" },
				{ "*", "expression_multiply", "functor" }, { "/", "expression_div", "functor" }, { "**", "expression_pow", "functor" },
				{ ">>", "expression_bitwise_shift_right", "functor" }, { "<<", "expression_bitwise_shift_left", "functor" },
				{ "/\\", "expression_bitwise_and", "functor" }, { "\\/", "expression_bitwise_or", "functor" },
				{ "//", "expression_integer_div", "functor" }, { "\\", "expression_bitwise_not", "functor" } };
	}
