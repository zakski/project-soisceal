...
import com.szadowsz.gospel.core.data.util.TermIterator;
import com.szadowsz.gospel.core.parser.Token;
import com.szadowsz.gospel.core.parser.Tokenizer;
...
public class Parser implements Serializable {
    ...
    public Term nextTerm(boolean endNeeded) throws InvalidTermException {
        try {
            ...
            if (term == null)
                ...
                throw new TermParsingException("The parser is unable to finish.",
            ...
            if (endNeeded && tokenizer.readToken().getType() != Tokenizer.END())
                ...
                throw new TermParsingException("The term '" + term + "' is not ended with a period.",
                        tokenizer.offsetToRowColumn(getCurrentOffset())[0],
                        tokenizer.offsetToRowColumn(getCurrentOffset())[1] - 1);
				/**/
            ...
            throw new TermParsingException("An I/O error occured.",
                    tokenizer.offsetToRowColumn(getCurrentOffset())[0],
                    tokenizer.offsetToRowColumn(getCurrentOffset())[1] - 1);
			/**/
        }
    ...
    private Term expr0() throws InvalidTermException, IOException {
		...
		*/
        ...
        if (t1.isType(Tokenizer.ATOM()) || t1.isType(Tokenizer.SQ_SEQUENCE()) || t1.isType(Tokenizer.DQ_SEQUENCE())) {
            ...
            throw new TermParsingException("Missing right parenthesis '(" + a + "' -> here <-",
                    tokenizer.offsetToRowColumn(getCurrentOffset())[0],
                    tokenizer.offsetToRowColumn(getCurrentOffset())[1] - 1);
			/**/
        }
        ...
        if (t1.isType(Tokenizer.LPAR())) {
            ...
            throw new TermParsingException("Missing right parenthesis '(" + term + "' -> here <-",
                    tokenizer.offsetToRowColumn(getCurrentOffset())[0],
                    tokenizer.offsetToRowColumn(getCurrentOffset())[1] - 1);
			/**/
        }
        ...
        if (t1.isType(Tokenizer.LBRA())) {
            ...
            throw new TermParsingException("Missing right bracket '[" + term + " ->' here <-",
                    tokenizer.offsetToRowColumn(getCurrentOffset())[0],
                    tokenizer.offsetToRowColumn(getCurrentOffset())[1] - 1);
			/**/
        }
        ...
        if (t1.isType(Tokenizer.LBRA2())) {
            ...
            throw new TermParsingException("Missing right braces '{" + arg + "' -> here <-",
                    tokenizer.offsetToRowColumn(getCurrentOffset())[0],
                    tokenizer.offsetToRowColumn(getCurrentOffset())[1] - 1);
			/**/
        }
        ...
        throw new TermParsingException("Unexpected token '" + t1.seq() + "'",
                tokenizer.offsetToRowColumn(getCurrentOffset())[0],
                tokenizer.offsetToRowColumn(getCurrentOffset())[1] - 1);
		/**/
    }
    ...
    private Term expr0_list() throws InvalidTermException, IOException {
        ...
        throw new TermParsingException("The expression '" + head + "' is not followed by either a ',' or '|'  or ']'.",
                tokenizer.offsetToRowColumn(getCurrentOffset())[0],
                tokenizer.offsetToRowColumn(getCurrentOffset())[1] - 1);
		/**/
    ...
    private LinkedList<Term> expr0_arglist() throws InvalidTermException, IOException {
		...
		/*Castagna 06/2011*/
        //throw new InvalidTermException("The argument: " + head + " is not followed by either a ',' or ')'.");
        throw new TermParsingException("The argument '" + head + "' is not followed by either a ',' or ')'.",
                tokenizer.offsetToRowColumn(getCurrentOffset())[0],
                tokenizer.offsetToRowColumn(getCurrentOffset())[1] - 1);
		/**/
    }
    ...
    static com.szadowsz.gospel.core.data.numeric.Number parseInteger(String s) {
