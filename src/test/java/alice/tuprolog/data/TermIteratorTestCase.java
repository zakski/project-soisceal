...
public class TermIteratorTestCase extends TestCase {
	...
	public void testMultipleNext() {
		...
		assertEquals(new Struct("q", new alice.tuprolog.core.data.numeric.Int(1)), i.next());
		assertEquals(new Struct("q", new alice.tuprolog.core.data.numeric.Int(2)), i.next());
		assertEquals(new Struct("q", new alice.tuprolog.core.data.numeric.Int(3)), i.next());
		assertEquals(new Struct("q", new alice.tuprolog.core.data.numeric.Int(5)), i.next());
		assertEquals(new Struct("q", new alice.tuprolog.core.data.numeric.Int(7)), i.next());
		// no more terms
		assertFalse(i.hasNext());
		try {
			i.next();
	...
	public void testIterationOnInvalidTheory() {
		String theory = "q(1)." + "\n" +
						...
						"q(5)." + "\n" +
						"q(7).";
		Struct firstTerm = new Struct("q", new alice.tuprolog.core.data.numeric.Int(1));
		Struct secondTerm = new Struct("q", new alice.tuprolog.core.data.numeric.Int(2));
