...
public class StructTestCase extends TestCase {
	...
	public void testStructWithNullArgument() {
		...
		try {
			new Struct("p", new alice.tuprolog.core.data.numeric.Int(1), null);
			fail();
		} catch (InvalidTermException expected) {}
		try {
			new Struct("p", new alice.tuprolog.core.data.numeric.Int(1), new alice.tuprolog.core.data.numeric.Int(2), null);
			fail();
		} catch (InvalidTermException expected) {}
		try {
			new Struct("p", new alice.tuprolog.core.data.numeric.Int(1), new alice.tuprolog.core.data.numeric.Int(2), new alice.tuprolog.core.data.numeric.Int(3), null);
			fail();
		} catch (InvalidTermException expected) {}
		try {
			new Struct("p", new alice.tuprolog.core.data.numeric.Int(1), new alice.tuprolog.core.data.numeric.Int(2), new alice.tuprolog.core.data.numeric.Int(3), new alice.tuprolog.core.data.numeric.Int(4), null);
			fail();
		} catch (InvalidTermException expected) {}
		try {
			new Struct("p", new alice.tuprolog.core.data.numeric.Int(1), new alice.tuprolog.core.data.numeric.Int(2), new alice.tuprolog.core.data.numeric.Int(3), new alice.tuprolog.core.data.numeric.Int(4), new alice.tuprolog.core.data.numeric.Int(5), null);
			fail();
		} catch (InvalidTermException expected) {}
		try {
			new Struct("p", new alice.tuprolog.core.data.numeric.Int(1), new alice.tuprolog.core.data.numeric.Int(2), new alice.tuprolog.core.data.numeric.Int(3), new alice.tuprolog.core.data.numeric.Int(4), new alice.tuprolog.core.data.numeric.Int(5), new alice.tuprolog.core.data.numeric.Int(6), null);
			fail();
		} catch (InvalidTermException expected) {}
		try {
	...
	public void testStructWithNullName() {
		try {
			new Struct(null, new alice.tuprolog.core.data.numeric.Int(1), new alice.tuprolog.core.data.numeric.Int(2));
			fail();
		} catch (InvalidTermException expected) {}
	}
	...
	public void testStructWithEmptyName() {
		try {
			new Struct("", new alice.tuprolog.core.data.numeric.Int(1), new alice.tuprolog.core.data.numeric.Int(2));
			fail();
		} catch (InvalidTermException expected) {}
	...
	public void testNonListTail() {
		Struct s = new Struct("h", new alice.tuprolog.core.data.numeric.Int(1));
		try {
	...
	public void testNonListIterator() {
		Struct s = new Struct("f", new alice.tuprolog.core.data.numeric.Int(2));
		try {
	...
	public void testToList() {
		...
		assertEquals(emptyListToList, emptyList.toListStruct());
	}
	...
	public void testIsAtomic() {
		...
		Struct list = new Struct(new Term[] {new alice.tuprolog.core.data.numeric.Int(0), new alice.tuprolog.core.data.numeric.Int(1)});
