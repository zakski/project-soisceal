...
public class ISOIOLibraryTestCase {
	...
	static alice.tuprolog.core.Prolog engine = null;
	String theory = null;
	Solution info = null;
    ...
    public static void initTest()
    {
        try
        {
            engine = new alice.tuprolog.core.Prolog(new String[] {"alice.tuprolog.lib.BasicLibrary","alice.tuprolog.lib.ISOIOLibrary"});
