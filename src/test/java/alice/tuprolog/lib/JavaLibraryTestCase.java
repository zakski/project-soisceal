...
import alice.tuprolog.TestCounter;
...
import alice.tuprolog.core.exception.interpreter.*;
...
public class JavaLibraryTestCase extends TestCase {
	...
	public void test_java_object() throws PrologException, IOException, NoSolutionException, MalformedGoalException, InvalidTheoryException {
		...
		alice.tuprolog.core.data.numeric.Number result2 = (alice.tuprolog.core.data.numeric.Number) info.getVarValue("Value");
	...
	public void test_java_object_2() throws PrologException, IOException, MalformedGoalException, InvalidTheoryException, NoSolutionException {
		...
		alice.tuprolog.core.data.numeric.Number result2 = (alice.tuprolog.core.data.numeric.Number) info.getVarValue("Res");
	...
	public void test_java_array() throws PrologException, IOException, MalformedGoalException, InvalidTheoryException, NoSolutionException {
		...
		info = engine.solve("demo(Value).");
		assertEquals(true, info.isSuccess());
		alice.tuprolog.core.data.numeric.Number resultInt = (alice.tuprolog.core.data.numeric.Number) info.getVarValue("Value");
		...
		info = engine.solve("demo(Value).");
		assertEquals(true, info.isSuccess());
		alice.tuprolog.core.data.numeric.Number resultInt2 = (alice.tuprolog.core.data.numeric.Number) info.getVarValue("Value");
