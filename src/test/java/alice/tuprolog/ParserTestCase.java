...
public class ParserTestCase extends TestCase {
	...
	public void testUnaryMinusOperator() throws InvalidTermException {
		...
		Struct result = new Struct("n", new alice.tuprolog.core.data.numeric.Int(-100));
		result.resolveTerm();
		assertEquals(result, p.nextTerm(true));
	}
	...
	public void testBinaryMinusOperator() throws InvalidTermException {
		...
		Struct result = new Struct("abs", new Struct("-", new alice.tuprolog.core.data.numeric.Int(3), new alice.tuprolog.core.data.numeric.Int(11)));
	...
	public void testIntegerBinaryRepresentation() throws InvalidTermException {
		...
		alice.tuprolog.core.data.numeric.Number result = new alice.tuprolog.core.data.numeric.Int(45);
		assertEquals(result, p.nextTerm(false));
	...
	public void testIntegerOctalRepresentation() throws InvalidTermException {
		String n = "0o77351";
		Parser p = new Parser(n);
		alice.tuprolog.core.data.numeric.Number result = new alice.tuprolog.core.data.numeric.Int(32489);
		assertEquals(result, p.nextTerm(false));
	...
	public void testIntegerHexadecimalRepresentation() throws InvalidTermException {
		String n = "0xDECAF";
		Parser p = new Parser(n);
		alice.tuprolog.core.data.numeric.Number result = new alice.tuprolog.core.data.numeric.Int(912559);
		assertEquals(result, p.nextTerm(false));
		String invalid = "0xG";
		try {
			new Parser(invalid).nextTerm(false);
