...
public class BasicLibraryExceptionsTestCase extends TestCase {
	...
	public void test_set_theory_1_2() throws Exception {
		...
		assertTrue(info.isSuccess());
		Struct g = (Struct) info.getTerm("Goal");
		assertTrue(g.isEqual(new Struct("set_theory", new alice.tuprolog.core.data.numeric.Int(1))));
		alice.tuprolog.core.data.numeric.Int argNo = (alice.tuprolog.core.data.numeric.Int) info.getTerm("ArgNo");
		assertTrue(argNo.intValue() == 1);
	...
	public void test_set_theory_1_3() throws Exception {
		...
		alice.tuprolog.core.data.numeric.Int line = (alice.tuprolog.core.data.numeric.Int) info.getTerm("Line");
		assertTrue(line.intValue() == 1);
		alice.tuprolog.core.data.numeric.Int position = (alice.tuprolog.core.data.numeric.Int) info.getTerm("Line");
	...
	public void test_add_theory_1_2() throws Exception {
		...
		assertTrue(info.isSuccess());
		Struct g = (Struct) info.getTerm("Goal");
		assertTrue(g.isEqual(new Struct("add_theory", new alice.tuprolog.core.data.numeric.Int(1))));
		alice.tuprolog.core.data.numeric.Int argNo = (alice.tuprolog.core.data.numeric.Int) info.getTerm("ArgNo");
		assertTrue(argNo.intValue() == 1);
		Struct validType = (Struct) info.getTerm("ValidType");
		assertTrue(validType.isEqual(new Struct("atom")));
	...
	public void test_agent_1_2() throws Exception {
		...
		assertTrue(info.isSuccess());
		Struct g = (Struct) info.getTerm("Goal");
		assertTrue(g.isEqual(new Struct("agent", new alice.tuprolog.core.data.numeric.Int(1))));
		alice.tuprolog.core.data.numeric.Int argNo = (alice.tuprolog.core.data.numeric.Int) info.getTerm("ArgNo");
		assertTrue(argNo.intValue() == 1);
		Struct validType = (Struct) info.getTerm("ValidType");
		assertTrue(validType.isEqual(new Struct("atom")));
	...
	public void test_agent_2_3() throws Exception {
		...
		assertTrue(info.isSuccess());
		Struct g = (Struct) info.getTerm("Goal");
		assertTrue(g.isEqual(new Struct("agent", new alice.tuprolog.core.data.numeric.Int(1), new Struct("a"))));
		alice.tuprolog.core.data.numeric.Int argNo = (alice.tuprolog.core.data.numeric.Int) info.getTerm("ArgNo");
		assertTrue(argNo.intValue() == 1);
		Struct validType = (Struct) info.getTerm("ValidType");
		assertTrue(validType.isEqual(new Struct("atom")));
	...
	public void test_agent_2_4() throws Exception {
		...
		assertTrue(info.isSuccess());
		Struct g = (Struct) info.getTerm("Goal");
		assertTrue(g.isEqual(new Struct("agent", new Struct("a"), new alice.tuprolog.core.data.numeric.Int(1))));
		alice.tuprolog.core.data.numeric.Int argNo = (alice.tuprolog.core.data.numeric.Int) info.getTerm("ArgNo");
		assertTrue(argNo.intValue() == 2);
		Struct validType = (Struct) info.getTerm("ValidType");
	...
	public void test_expression_comparison_2_1() throws Exception {
		...
		assertTrue(g.isEqual(new Struct("expression_equality", new Var("X"),
				new alice.tuprolog.core.data.numeric.Int(1))));
		alice.tuprolog.core.data.numeric.Int argNo = (alice.tuprolog.core.data.numeric.Int) info.getTerm("ArgNo");
		assertTrue(argNo.intValue() == 1);
	}
	...
	public void test_expression_comparison_2_2() throws Exception {
		...
		assertTrue(info.isSuccess());
		Struct g = (Struct) info.getTerm("Goal");
		assertTrue(g.isEqual(new Struct("expression_equality", new alice.tuprolog.core.data.numeric.Int(1),
				new Var("X"))));
		alice.tuprolog.core.data.numeric.Int argNo = (alice.tuprolog.core.data.numeric.Int) info.getTerm("ArgNo");
		assertTrue(argNo.intValue() == 2);
	}
	...
	public void test_expression_comparison_2_9() throws Exception {
		...
		assertTrue(g.isEqual(new Struct("expression_greater_than",
				new Var("X"), new alice.tuprolog.core.data.numeric.Int(1))));
		alice.tuprolog.core.data.numeric.Int argNo = (alice.tuprolog.core.data.numeric.Int) info.getTerm("ArgNo");
		assertTrue(argNo.intValue() == 1);
	}
	...
	public void test_expression_comparison_2_10() throws Exception {
		...
		assertTrue(info.isSuccess());
		Struct g = (Struct) info.getTerm("Goal");
		assertTrue(g.isEqual(new Struct("expression_greater_than", new alice.tuprolog.core.data.numeric.Int(1),
				new Var("X"))));
		alice.tuprolog.core.data.numeric.Int argNo = (alice.tuprolog.core.data.numeric.Int) info.getTerm("ArgNo");
		assertTrue(argNo.intValue() == 2);
	}
	...
	public void test_expression_comparison_2_11() throws Exception {
		...
		assertTrue(g.isEqual(new Struct("expression_greater_than", new Struct(
				"a"), new alice.tuprolog.core.data.numeric.Int(1))));
		alice.tuprolog.core.data.numeric.Int argNo = (alice.tuprolog.core.data.numeric.Int) info.getTerm("ArgNo");
		assertTrue(argNo.intValue() == 1);
		Struct validType = (Struct) info.getTerm("ValidType");
		assertTrue(validType.isEqual(new Struct("evaluable")));
	...
	public void test_expression_comparison_2_14() throws Exception {
		...
		assertTrue(info.isSuccess());
		Struct g = (Struct) info.getTerm("Goal");
		assertTrue(g.isEqual(new Struct("expression_less_than", new alice.tuprolog.core.data.numeric.Int(1),
				new Var("X"))));
		alice.tuprolog.core.data.numeric.Int argNo = (alice.tuprolog.core.data.numeric.Int) info.getTerm("ArgNo");
		assertTrue(argNo.intValue() == 2);
	}
	...
	public void test_expression_comparison_2_15() throws Exception {
		...
		assertTrue(g.isEqual(new Struct("expression_less_than",
				new Struct("a"), new alice.tuprolog.core.data.numeric.Int(1))));
		alice.tuprolog.core.data.numeric.Int argNo = (alice.tuprolog.core.data.numeric.Int) info.getTerm("ArgNo");
		assertTrue(argNo.intValue() == 1);
		Struct validType = (Struct) info.getTerm("ValidType");
		assertTrue(validType.isEqual(new Struct("evaluable")));
	...
	public void test_expression_comparison_2_18() throws Exception {
		...
		Struct g = (Struct) info.getTerm("Goal");
		assertTrue(g.isEqual(new Struct("expression_greater_or_equal_than",
				new alice.tuprolog.core.data.numeric.Int(1), new Var("X"))));
		alice.tuprolog.core.data.numeric.Int argNo = (alice.tuprolog.core.data.numeric.Int) info.getTerm("ArgNo");
		assertTrue(argNo.intValue() == 2);
	}
	...
	public void test_expression_comparison_2_20() throws Exception {
		...
		Struct g = (Struct) info.getTerm("Goal");
		assertTrue(g.isEqual(new Struct("expression_greater_or_equal_than",
				new alice.tuprolog.core.data.numeric.Int(1), new Struct("a"))));
		alice.tuprolog.core.data.numeric.Int argNo = (alice.tuprolog.core.data.numeric.Int) info.getTerm("ArgNo");
		assertTrue(argNo.intValue() == 2);
		Struct validType = (Struct) info.getTerm("ValidType");
		assertTrue(validType.isEqual(new Struct("evaluable")));
	...
	public void test_expression_comparison_2_25() throws Exception {
		...
		Struct g = (Struct) info.getTerm("Goal");
		assertTrue(g.isEqual(new Struct("expression_equality", new alice.tuprolog.core.data.numeric.Int(1),
				new Struct("/", new alice.tuprolog.core.data.numeric.Int(1), new alice.tuprolog.core.data.numeric.Int(0)))));
		alice.tuprolog.core.data.numeric.Int argNo = (alice.tuprolog.core.data.numeric.Int) info.getTerm("ArgNo");
		assertTrue(argNo.intValue() == 2);
	...
	public void test_expression_comparison_2_29() throws Exception {
		...
		Struct g = (Struct) info.getTerm("Goal");
		assertTrue(g.isEqual(new Struct("expression_greater_or_equal_than",
				new alice.tuprolog.core.data.numeric.Int(1), new Struct("/", new alice.tuprolog.core.data.numeric.Int(1), new alice.tuprolog.core.data.numeric.Int(0)))));
		alice.tuprolog.core.data.numeric.Int argNo = (alice.tuprolog.core.data.numeric.Int) info.getTerm("ArgNo");
		assertTrue(argNo.intValue() == 2);
		Struct validType = (Struct) info.getTerm("Error");
		assertTrue(validType.isEqual(new Struct("zero_divisor")));
	...
	public void test_expression_comparison_2_37() throws Exception {
		...
		assertTrue(g.isEqual(new Struct("expression_equality", new Struct(
				"div", new alice.tuprolog.core.data.numeric.Int(1), new alice.tuprolog.core.data.numeric.Int(0)), new alice.tuprolog.core.data.numeric.Int(1))));
		alice.tuprolog.core.data.numeric.Int argNo = (alice.tuprolog.core.data.numeric.Int) info.getTerm("ArgNo");
		assertTrue(argNo.intValue() == 1);
		Struct validType = (Struct) info.getTerm("Error");
		assertTrue(validType.isEqual(new Struct("zero_divisor")));
	...
	public void test_expression_comparison_2_41() throws Exception {
		...
		Struct g = (Struct) info.getTerm("Goal");
		assertTrue(g.isEqual(new Struct("expression_greater_or_equal_than",
				new Struct("div", new alice.tuprolog.core.data.numeric.Int(1), new alice.tuprolog.core.data.numeric.Int(0)), new alice.tuprolog.core.data.numeric.Int(1))));
		alice.tuprolog.core.data.numeric.Int argNo = (alice.tuprolog.core.data.numeric.Int) info.getTerm("ArgNo");
		assertTrue(argNo.intValue() == 1);
		Struct validType = (Struct) info.getTerm("Error");
		assertTrue(validType.isEqual(new Struct("zero_divisor")));
	...
	public void test_text_concat_3_3() throws Exception {
		...
		assertTrue(info.isSuccess());
		Struct g = (Struct) info.getTerm("Goal");
		assertTrue(g.isEqual(new Struct("text_concat", new alice.tuprolog.core.data.numeric.Int(1), new Struct(
				"a"), new Struct("b"))));
		alice.tuprolog.core.data.numeric.Int argNo = (alice.tuprolog.core.data.numeric.Int) info.getTerm("ArgNo");
		assertTrue(argNo.intValue() == 1);
		Struct validType = (Struct) info.getTerm("ValidType");
	...
	public void test_text_concat_3_4() throws Exception {
		...
		Struct g = (Struct) info.getTerm("Goal");
		assertTrue(g.isEqual(new Struct("text_concat", new Struct("a"),
				new alice.tuprolog.core.data.numeric.Int(1), new Struct("b"))));
		alice.tuprolog.core.data.numeric.Int argNo = (alice.tuprolog.core.data.numeric.Int) info.getTerm("ArgNo");
		assertTrue(argNo.intValue() == 2);
		Struct validType = (Struct) info.getTerm("ValidType");
		assertTrue(validType.isEqual(new Struct("atom")));
	...
	public void test_num_atom_2_2() throws Exception {
		...
		assertTrue(info.isSuccess());
		Struct g = (Struct) info.getTerm("Goal");
		assertTrue(g.isEqual(new Struct("num_atom", new alice.tuprolog.core.data.numeric.Int(1), new alice.tuprolog.core.data.numeric.Int(1))));
		alice.tuprolog.core.data.numeric.Int argNo = (alice.tuprolog.core.data.numeric.Int) info.getTerm("ArgNo");
		assertTrue(argNo.intValue() == 2);
		Struct validType = (Struct) info.getTerm("ValidType");
		assertTrue(validType.isEqual(new Struct("atom")));
	...
	public void test_num_atom_2_3() throws Exception {
		...
		Struct g = (Struct) info.getTerm("Goal");
		assertTrue(g
				.isEqual(new Struct("num_atom", new alice.tuprolog.core.data.numeric.Int(1), new Struct("a"))));
		alice.tuprolog.core.data.numeric.Int argNo = (alice.tuprolog.core.data.numeric.Int) info.getTerm("ArgNo");
		assertTrue(argNo.intValue() == 2);
	...
	public void test_arg_3_1() throws Exception {
		...
		assertTrue(g.isEqual(new Struct("arg_guard", new Var("X"), new Struct(
				"p", new alice.tuprolog.core.data.numeric.Int(1)), new alice.tuprolog.core.data.numeric.Int(1))));
		alice.tuprolog.core.data.numeric.Int argNo = (alice.tuprolog.core.data.numeric.Int) info.getTerm("ArgNo");
		assertTrue(argNo.intValue() == 1);
	}
	...
	public void test_arg_3_2() throws Exception {
		...
		assertTrue(info.isSuccess());
		Struct g = (Struct) info.getTerm("Goal");
		assertTrue(g.isEqual(new Struct("arg_guard", new alice.tuprolog.core.data.numeric.Int(1), new Var("X"),
				new alice.tuprolog.core.data.numeric.Int(1))));
		alice.tuprolog.core.data.numeric.Int argNo = (alice.tuprolog.core.data.numeric.Int) info.getTerm("ArgNo");
		assertTrue(argNo.intValue() == 2);
	}
	...
	public void test_arg_3_3() throws Exception {
		...
		assertTrue(g.isEqual(new Struct("arg_guard", new Struct("a"),
				new Struct("p", new alice.tuprolog.core.data.numeric.Int(1)), new alice.tuprolog.core.data.numeric.Int(1))));
		alice.tuprolog.core.data.numeric.Int argNo = (alice.tuprolog.core.data.numeric.Int) info.getTerm("ArgNo");
		assertTrue(argNo.intValue() == 1);
		Struct validType = (Struct) info.getTerm("ValidType");
	...
	public void test_arg_3_4() throws Exception {
		...
		assertTrue(info.isSuccess());
		Struct g = (Struct) info.getTerm("Goal");
		assertTrue(g.isEqual(new Struct("arg_guard", new alice.tuprolog.core.data.numeric.Int(1),
				new Struct("p"), new alice.tuprolog.core.data.numeric.Int(1))));
		alice.tuprolog.core.data.numeric.Int argNo = (alice.tuprolog.core.data.numeric.Int) info.getTerm("ArgNo");
		assertTrue(argNo.intValue() == 2);
		Struct validType = (Struct) info.getTerm("ValidType");
	...
	public void test_arg_3_5() throws Exception {
		...
		assertTrue(info.isSuccess());
		Struct g = (Struct) info.getTerm("Goal");
		assertTrue(g.isEqual(new Struct("arg_guard", new alice.tuprolog.core.data.numeric.Int(0), new Struct(
				"p", new alice.tuprolog.core.data.numeric.Int(0)), new alice.tuprolog.core.data.numeric.Int(1))));
		alice.tuprolog.core.data.numeric.Int argNo = (alice.tuprolog.core.data.numeric.Int) info.getTerm("ArgNo");
		assertTrue(argNo.intValue() == 1);
	...
	public void test_call_1_2() throws Exception {
		...
		assertTrue(info.isSuccess());
		Struct g = (Struct) info.getTerm("Goal");
		assertTrue(g.isEqual(new Struct("call_guard", new alice.tuprolog.core.data.numeric.Int(1))));
		alice.tuprolog.core.data.numeric.Int argNo = (alice.tuprolog.core.data.numeric.Int) info.getTerm("ArgNo");
		assertTrue(argNo.intValue() == 1);
		Struct validType = (Struct) info.getTerm("ValidType");
	...
	public void test_findall_3_2() throws Exception {
		...
		Struct g = (Struct) info.getTerm("Goal");
		assertTrue(g.isEqual(new Struct("all_solutions_predicates_guard",
				new Struct("a"), new alice.tuprolog.core.data.numeric.Int(1), new Var("L"))));
		alice.tuprolog.core.data.numeric.Int argNo = (alice.tuprolog.core.data.numeric.Int) info.getTerm("ArgNo");
		assertTrue(argNo.intValue() == 2);
		Struct validType = (Struct) info.getTerm("ValidType");
		assertTrue(validType.isEqual(new Struct("callable")));
	...
	public void test_assert_1_2() throws Exception {
		...
		assertTrue(info.isSuccess());
		Struct g = (Struct) info.getTerm("Goal");
		assertTrue(g.isEqual(new Struct("assertz", new alice.tuprolog.core.data.numeric.Int(1))));
		alice.tuprolog.core.data.numeric.Int argNo = (alice.tuprolog.core.data.numeric.Int) info.getTerm("ArgNo");
		assertTrue(argNo.intValue() == 1);
		Struct validType = (Struct) info.getTerm("ValidType");
	...
	public void test_retract_1_2() throws Exception {
		...
		assertTrue(info.isSuccess());
		Struct g = (Struct) info.getTerm("Goal");
		assertTrue(g.isEqual(new Struct("retract_guard", new alice.tuprolog.core.data.numeric.Int(1))));
		alice.tuprolog.core.data.numeric.Int argNo = (alice.tuprolog.core.data.numeric.Int) info.getTerm("ArgNo");
		assertTrue(argNo.intValue() == 1);
		Struct validType = (Struct) info.getTerm("ValidType");
		assertTrue(validType.isEqual(new Struct("clause")));
	...
	public void test_element_3_1() throws Exception {
		...
		assertTrue(info.isSuccess());
		Struct g = (Struct) info.getTerm("Goal");
		assertTrue(g.isEqual(new Struct("element_guard", new alice.tuprolog.core.data.numeric.Int(1),
