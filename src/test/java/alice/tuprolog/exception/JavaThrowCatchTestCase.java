...
public class JavaThrowCatchTestCase extends TestCase {
	...
	public void test_java_catch_3_1() throws Exception {
		...
		alice.tuprolog.core.data.numeric.Int cause = (alice.tuprolog.core.data.numeric.Int) info.getTerm("Cause");
		...
		alice.tuprolog.core.data.numeric.Int x = (alice.tuprolog.core.data.numeric.Int) info.getTerm("X");
		assertTrue(x.intValue() == 2);
		alice.tuprolog.core.data.numeric.Int y = (alice.tuprolog.core.data.numeric.Int) info.getTerm("Y");
		assertTrue(y.intValue() == 5);
		alice.tuprolog.core.data.numeric.Int z = (alice.tuprolog.core.data.numeric.Int) info.getTerm("Z");
	...
	public void test_java_catch_3_7() throws Exception {
		...
		assertTrue(y instanceof alice.tuprolog.core.data.numeric.Int);
		assertTrue(((alice.tuprolog.core.data.numeric.Int) y).intValue() == 8);
	}
