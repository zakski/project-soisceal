...
public class BuiltInExceptionsTestCase extends TestCase {
	...
	public void test_asserta_1_2() throws Exception {
		...
		assertTrue(info.isSuccess());
		Struct g = (Struct) info.getTerm("Goal");
		assertTrue(g.isEqual(new Struct("asserta", new alice.tuprolog.core.data.numeric.Int(1))));
		alice.tuprolog.core.data.numeric.Int argNo = (alice.tuprolog.core.data.numeric.Int) info.getTerm("ArgNo");
		assertTrue(argNo.intValue() == 1);
	...
	public void test_$retract_1_2() throws Exception {
		...
		assertTrue(info.isSuccess());
		Struct g = (Struct) info.getTerm("Goal");
		assertTrue(g.isEqual(new Struct("$retract", new alice.tuprolog.core.data.numeric.Int(1))));
		alice.tuprolog.core.data.numeric.Int argNo = (alice.tuprolog.core.data.numeric.Int) info.getTerm("ArgNo");
		assertTrue(argNo.intValue() == 1);
		Struct validType = (Struct) info.getTerm("ValidType");
		assertTrue(validType.isEqual(new Struct("clause")));
	...
	public void test_abolish_1_2() throws Exception {
		...
		assertTrue(info.isSuccess());
		Struct g = (Struct) info.getTerm("Goal");
		assertTrue(g.isEqual(new Struct("abolish", new alice.tuprolog.core.data.numeric.Int(1))));
		alice.tuprolog.core.data.numeric.Int argNo = (alice.tuprolog.core.data.numeric.Int) info.getTerm("ArgNo");
		assertTrue(argNo.intValue() == 1);
		Struct validType = (Struct) info.getTerm("ValidType");
	...
	public void test_halt_1_2() throws Exception {
		...
		assertTrue(info.isSuccess());
		Struct g = (Struct) info.getTerm("Goal");
		assertTrue(g.isEqual(new Struct("halt", new alice.tuprolog.core.data.numeric.Double(1.5))));
		alice.tuprolog.core.data.numeric.Int argNo = (alice.tuprolog.core.data.numeric.Int) info.getTerm("ArgNo");
		assertTrue(argNo.intValue() == 1);
		Struct validType = (Struct) info.getTerm("ValidType");
		assertTrue(validType.isEqual(new Struct("integer")));
		alice.tuprolog.core.data.numeric.Double culprit = (alice.tuprolog.core.data.numeric.Double) info.getTerm("Culprit");
	...
	public void test_load_library_1_2() throws Exception {
		...
		assertTrue(info.isSuccess());
		Struct g = (Struct) info.getTerm("Goal");
		assertTrue(g.isEqual(new Struct("load_library", new alice.tuprolog.core.data.numeric.Int(1))));
		alice.tuprolog.core.data.numeric.Int argNo = (alice.tuprolog.core.data.numeric.Int) info.getTerm("ArgNo");
		assertTrue(argNo.intValue() == 1);
		Struct validType = (Struct) info.getTerm("ValidType");
	...
	public void test_load_library_1_3() throws Exception {
		...
		assertTrue(message.isEqual(new Struct("Library \"a\" Not Found.")));
	}
	...
	public void test_unload_library_1_2() throws Exception {
		...
		assertTrue(info.isSuccess());
		Struct g = (Struct) info.getTerm("Goal");
		assertTrue(g.isEqual(new Struct("unload_library", new alice.tuprolog.core.data.numeric.Int(1))));
		alice.tuprolog.core.data.numeric.Int argNo = (alice.tuprolog.core.data.numeric.Int) info.getTerm("ArgNo");
		assertTrue(argNo.intValue() == 1);
		Struct validType = (Struct) info.getTerm("ValidType");
		assertTrue(validType.isEqual(new Struct("atom")));
	...
	public void test_$call_1_2() throws Exception {
		...
		assertTrue(info.isSuccess());
		Struct g = (Struct) info.getTerm("Goal");
		assertTrue(g.isEqual(new Struct("$call", new alice.tuprolog.core.data.numeric.Int(1))));
		alice.tuprolog.core.data.numeric.Int argNo = (alice.tuprolog.core.data.numeric.Int) info.getTerm("ArgNo");
		assertTrue(argNo.intValue() == 1);
		Struct validType = (Struct) info.getTerm("ValidType");
	...
	public void test_is_2_3() throws Exception {
		...
		assertTrue(info.isSuccess());
		Struct g = (Struct) info.getTerm("Goal");
		assertTrue(g.isEqual(new Struct("is", new Var("X"), new Struct("/", new alice.tuprolog.core.data.numeric.Int(1), new alice.tuprolog.core.data.numeric.Int(0)))));
		alice.tuprolog.core.data.numeric.Int argNo = (alice.tuprolog.core.data.numeric.Int) info.getTerm("ArgNo");
		assertTrue(argNo.intValue() == 2);
	...
	public void test_is_2_5() throws Exception {
		...
		assertTrue(info.isSuccess());
		Struct g = (Struct) info.getTerm("Goal");
		assertTrue(g.isEqual(new Struct("is", new Var("X"), new Struct("div", new alice.tuprolog.core.data.numeric.Int(1), new alice.tuprolog.core.data.numeric.Int(0)))));
		alice.tuprolog.core.data.numeric.Int argNo = (alice.tuprolog.core.data.numeric.Int) info.getTerm("ArgNo");
		assertTrue(argNo.intValue() == 2);
		Struct error = (Struct) info.getTerm("Error");
		assertTrue(error.isEqual(new Struct("zero_divisor")));
	...
	public void test_$tolist_2_2() throws Exception {
		...
		Struct g = (Struct) info.getTerm("Goal");
		assertTrue(g
				.isEqual(new Struct("$tolist", new alice.tuprolog.core.data.numeric.Int(1), new Var("List"))));
		alice.tuprolog.core.data.numeric.Int argNo = (alice.tuprolog.core.data.numeric.Int) info.getTerm("ArgNo");
		assertTrue(argNo.intValue() == 1);
		Struct validType = (Struct) info.getTerm("ValidType");
	...
	public void test_set_prolog_flag_2_3() throws Exception {
		...
		assertTrue(info.isSuccess());
		Struct g = (Struct) info.getTerm("Goal");
		assertTrue(g.isEqual(new Struct("set_prolog_flag", new alice.tuprolog.core.data.numeric.Int(1), new alice.tuprolog.core.data.numeric.Int(
				1))));
		alice.tuprolog.core.data.numeric.Int argNo = (alice.tuprolog.core.data.numeric.Int) info.getTerm("ArgNo");
		assertTrue(argNo.intValue() == 1);
		Struct validType = (Struct) info.getTerm("ValidType");
	...
	public void test_set_prolog_flag_2_7() throws Exception {
		...
		Term message = info.getTerm("Message");
		assertTrue(message.isEqual(new alice.tuprolog.core.data.numeric.Int(0)));
	}
	...
	public void test_get_prolog_flag_2_2() throws Exception {
		...
		assertTrue(info.isSuccess());
		Struct g = (Struct) info.getTerm("Goal");
		assertTrue(g.isEqual(new Struct("get_prolog_flag", new alice.tuprolog.core.data.numeric.Int(1), new Var(
				"Value"))));
		alice.tuprolog.core.data.numeric.Int argNo = (alice.tuprolog.core.data.numeric.Int) info.getTerm("ArgNo");
		assertTrue(argNo.intValue() == 1);
		Struct validType = (Struct) info.getTerm("ValidType");
	...
	public void test_$op_3_2() throws Exception {
		...
		assertTrue(info.isSuccess());
		Struct g = (Struct) info.getTerm("Goal");
		assertTrue(g.isEqual(new Struct("$op", new alice.tuprolog.core.data.numeric.Int(600), new Var(
	...
	public void test_$op_3_3() throws Exception {
		...
		assertTrue(info.isSuccess());
		Struct g = (Struct) info.getTerm("Goal");
		assertTrue(g.isEqual(new Struct("$op", new alice.tuprolog.core.data.numeric.Int(600), new Struct("yfx"),
				new Var("Operator"))));
		alice.tuprolog.core.data.numeric.Int argNo = (alice.tuprolog.core.data.numeric.Int) info.getTerm("ArgNo");
	...
	public void test_$op_3_5() throws Exception {
		...
		assertTrue(info.isSuccess());
		Struct g = (Struct) info.getTerm("Goal");
		assertTrue(g.isEqual(new Struct("$op", new alice.tuprolog.core.data.numeric.Int(600), new alice.tuprolog.core.data.numeric.Int(1),
				new Struct("+"))));
		alice.tuprolog.core.data.numeric.Int argNo = (alice.tuprolog.core.data.numeric.Int) info.getTerm("ArgNo");
		assertTrue(argNo.intValue() == 2);
		Struct validType = (Struct) info.getTerm("ValidType");
	...
	public void test_$op_3_7() throws Exception {
		...
		assertTrue(info.isSuccess());
		Struct g = (Struct) info.getTerm("Goal");
		assertTrue(g.isEqual(new Struct("$op", new alice.tuprolog.core.data.numeric.Int(1300),
	...
	public void test_$op_3_8() throws Exception {
		...
		assertTrue(info.isSuccess());
		Struct g = (Struct) info.getTerm("Goal");
		assertTrue(g.isEqual(new Struct("$op", new alice.tuprolog.core.data.numeric.Int(600), new Struct("a"),
				new Struct("+"))));
		alice.tuprolog.core.data.numeric.Int argNo = (alice.tuprolog.core.data.numeric.Int) info.getTerm("ArgNo");
		assertTrue(argNo.intValue() == 2);
		Struct validDomain = (Struct) info.getTerm("ValidDomain");
