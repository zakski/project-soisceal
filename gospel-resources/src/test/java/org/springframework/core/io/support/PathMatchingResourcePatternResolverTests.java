...
public class PathMatchingResourcePatternResolverTests {
	...
	private static final String[] CLASSES_IN_COMMONS_LANG =
			new String[] {
	...
	public void singleResourceInJar() throws IOException {
		Resource[] resources = resolver.getResources("java/lang/String.class");
		assertEquals(1, resources.length);
		assertProtocolAndFilenames(resources, "jar", "String.class");
	}
	...
	public void classpathWithPatternInJar() throws IOException {
		Resource[] resources = resolver.getResources("classpath:org/apache/commons/lang3/exception/*.class");
		assertProtocolAndFilenames(resources, "jar", CLASSES_IN_COMMONS_LANG);
	}
