...
public class TheoryEvent extends PrologEvent {
    ...
    private ITheory oldTh;
    private ITheory newTh;
    
    public TheoryEvent(Prolog source, ITheory oldth, ITheory newth){
        super(source);
            oldTh=oldth;
            newTh=newth;
        }
