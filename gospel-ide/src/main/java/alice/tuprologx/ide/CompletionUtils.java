...
class CompletionUtils {
    ...
    private static final int DOCS_COMPLETIONS_RELEVANCE = 200;
    private static final int TEMPLATE_COMPLETIONS_RELEVANCE = 100;
    ...
    private static void createCompletionsFromDocs(AbstractCompletionProvider provider,
        ...
        try {
            ...
            HashMap<AbstractCompletion, String> addedCompletionsToLibraryName = new HashMap<>();
            ...
            List<String> libraryNames = new ArrayList<>(new HashSet<>(addedCompletionsToLibraryName.values()));
    ...
    private static Completion AddKeywordCompletion(AbstractCompletionProvider provider, String name, String doc) {
...
class CompletionUpdateTheoryListener implements TheoryListener {
    ...
    private final LinkedList<Completion> addedTheoryCompletions = new LinkedList<>();
