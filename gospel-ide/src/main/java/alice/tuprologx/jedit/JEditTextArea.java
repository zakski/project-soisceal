...
class JEditTextArea extends JComponent {
     ...
     */
    private void setHorizontalOffset(int horizontalOffset) {
     ...
     */
    private boolean setOrigin(int firstLine, int horizontalOffset) {
     ...
     */
    private boolean scrollTo(int line, int offset) {
