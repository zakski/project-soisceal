...
public class PJ implements MethodHandler {
    private static int reentrant = 0;
    ...
    private static <T> T newInstance(Class<?> cl, Theory init) throws Exception {
    ...
    private Object invokeInternal(Object receiver, Method method, Object[] args) {
