...
public class OOLibrary extends JLibrary {
    ...
    public String getTheory() {
        return
                //
                // operators defined by the JLibrary theory
                //
                ":- op(800,xfx,'<-').\n"
                        + ":- op(850,xfx,'returns').\n"
                        + ":- op(200,xfx,'as').\n"
    ...
    public boolean java_call_3(Term objId, Term method_name, Term idResult)
        ...
        try {
            ...
            getEngine().warn("Method failed: " + methodName + " - ( signature: " + args + " ) - Original Exception: " + ex.getTargetException());
            throw new JavaException(new IllegalArgumentException());
        } catch (NoSuchMethodException ex) {
            getEngine().warn("Method not found: " + methodName + " - ( signature: " + args + " )");
            throw new JavaException(ex);
    ...
    public boolean get_classpath_1(Term paths) throws JavaException {
        try {
            ...
            if (urls.length > 0) {
                ...
                stringURLs = "[]";
            pathTerm = getEngine().createTerm(stringURLs);
    ...
    public boolean java_array_get_primitive_3(Term obj_id, Term i, Term what) throws JavaException {
        ...
        try {
            ...
            if (name.equals("class [I")) {
                ...
                Term value = new com.szadowsz.gospel.core.data.Float(Array.getFloat(obj, index
                        .intValue()));
                if (unify(what, value))
                    return true;
                else
                ...
                Term value = new com.szadowsz.gospel.core.data.Long(Array.getLong(obj, index
                        .intValue()));
                if (unify(what, value))
                    return true;
                else
     ...
     * the object is getEngine() life-time, available besides the individual query.
     *
